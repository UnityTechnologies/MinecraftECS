# MinecraftECS with Unity 2019.3 & Latest ECS Packages
...
The code is about how to create a Minecraft-like environment using Unity's [ECS (Entity Component System)](https://docs.unity3d.com/Packages/com.unity.entities@0.8/manual/index.html).
